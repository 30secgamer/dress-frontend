  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-4 flex flex-col items-center transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
      ...
      {product.discountedPrice ? (
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-purple-600 font-semibold mt-1 text-lg">
      ...
      <div className="flex items-center mt-3 gap-2">
        <button
          ...
          className="px-3 py-1 bg-purple-200 rounded hover:bg-purple-300 transition-colors duration-300"
        >
          -
        </button>
      ...
      <button
        ...
        className="mt-4 w-full bg-purple-600 hover:bg-pink-400 text-white py-2 rounded-full font-bold transition-all duration-300 transform hover:-translate-y-1 hover:scale-105"
      >
        View Details
      </button>
    </div>
